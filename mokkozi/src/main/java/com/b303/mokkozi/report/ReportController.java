...
public class ReportController {
    ...
    public ResponseEntity<? extends BaseResponseBody> getUserReportList(@RequestParam @ApiParam(value = "신고 페이지 Index", defaultValue = "0") int page,
        ...
        try {
            ...
            Page<ReportUserDto> reportList = reportService.getUserReportList(page, result);
    ...
    public ResponseEntity<? extends BaseResponseBody> getUserReportList(@RequestParam @ApiParam(value = "사용자 신고 ID", defaultValue = "0") Long reportId
            , @ApiIgnore Authentication authentication
    ) {
