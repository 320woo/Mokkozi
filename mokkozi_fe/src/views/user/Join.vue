        ...
        >
          <form @submit.prevent="submit">
            ...
            <v-col class="input" cols="10">
              <h3>💑 안녕하세요! 모꼬지에 오신걸 환영합니다😊 <br>기본 인적 사항을 입력해 주세요!</h3>
              <!-- 이메일 입력란 -->
              <ValidationProvider name="이메일" rules="required" v-slot="{ errors }">
                <v-text-field
                class="m-0"
                label="이메일"
            ...
            <v-col class="input" cols="10">
              <h3>🏠 다음으로 현재 거주중인 주소지를 입력해 주세요!<br> (주변에 있는 이성을 추천할 때 활용됩니다)</h3>
              <!-- Address 1 -->
            ...
            <!-- 관심사 선택하기 -->
            <v-col class="input" cols="10">
              <h3>🎈 다음으로 본인의 관심사를 선택해 주세요! <br> (3가지 이상 선택해 주세요!)</h3>
            ...
            <v-col class="input" cols="10">
              <!-- 대표 프로필 설정하기 -->
              <h3>🎉이성에게 보여줄 예쁘고 멋진 대표 프로필 이미지를 선택해 주세요😄</h3>
              <ValidationProvider name="프로필이미지" rules="fileRequired:2000|required" v-slot="{ errors }">
                <v-file-input
              ...
              <h3>👍마지막이에요! 이성에게 보여줄 일상적인 나만의 모습을 선택해 주세요! (3개의 사진을 선택해 주세요)</h3>
              <ValidationProvider name="이미지" rules="fileRequired:10000|required" v-slot="{ errors }">
                <v-file-input
